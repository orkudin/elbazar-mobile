...
//     final responseAsyncGetSellers =
//         ref.watch(adminGetAllSellersProvider(_params));
...
//           filterSellers(),
//           Expanded(
//             child: responseAsyncGetSellers.when(
//               data: (sellers) => ListView.builder(
//                 itemCount: sellers.length,
//                 itemBuilder: (context, index) {
//                   final sellerInfo = sellers[index];
//                   return ListTile(
...
class _AdminScreenState extends ConsumerState<AdminScreen> {
  ...
  Future<void> _fetchPage(int pageKey) async {
    try {
      final responseAsyncGetSellers = await ref.read(
